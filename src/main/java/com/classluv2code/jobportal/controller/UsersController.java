...
import com.classluv2code.jobportal.services.UsersTypeService;
...
public class UsersController {
    ...
    public String userRegistration(@Valid Users user
        ...
        if(optionalUsers.isPresent()){
            model.addAttribute("error", "Email already registered, try to login or register other email.");
            return register(model);
        }
        System.out.println(usersService.addNewUser(user));
